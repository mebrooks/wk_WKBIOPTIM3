	...
	# 20180917 - added removal of NAs from stand_err_mean_x
												...
												#ATTT!!!!		
													...
													# output
														...
														# output
														data.frame(var=variable, stages = sampling_options$stages, n_stage1 = sampling_options$stage1_samp_size, strata_var = sampling_options$strata_var, n = length(x), estim_weight = NA, NAs_x = length(x) - length(na.omit(x)), mean=NA, se = NA, cv=NA, min = NA, median = NA, max = NA, n_class_sampled=NA,
